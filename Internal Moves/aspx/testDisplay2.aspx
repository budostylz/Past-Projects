                                            ...
                                            <table style="width:100%">
													<tr>
														...
														<td  class="readonlyBlock">                                              
															...
															<td>
																<span>	Last Modified 12/11/2018</span>
															</td>
													</tr>

													<tr>

														<td valign="top" class="ms-formlabel">Type of Internal Change:</td>
								...
								<div id="personnelInfo" class="divGroup">
									...
									<table style="width:100%">
										<tbody>
											...
											<td valign="top" class="ms-formlabel">Email Address:</td>
											<td valign="top" class="readonlyBlock">
										...
										<tbody>
											...
											<tr>
												<td valign="top" class="ms-formlabel">
													...
													<td valign="top" class="ms-formbody">
                                                        <span class="readonlyBlock"><xsl:value-of select="@admincompletedate"/></span>
													</td>
