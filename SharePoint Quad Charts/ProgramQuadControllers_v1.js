...
function ($q, $SourceDataDOMService, $PageLoadService, $ProgramService,$GetItemsService) {
    ...
    try{
        ...
        $( document ).ready(function() {
                ...
                jQuery("#ADDPIC").click(function(e) {
                    ...
                    var redirect = $ProgramService.updateProgramCapabilityPic(program);
                ...
                jQuery("#DELETEPIC").click(function(e) {
                ...
                jQuery("#roots").on( "click", "input", function(e) {//ROOTS
                    ...
                    bosRootSourceData.then(function (bosRootData) {//BOS-ROOT SOURCE DATA
                        ...
                        vm.key4s = key4DB().distinct('OData__x004b_ey4');//USE  SITE COLUMN INSTEAD
                ...
                jQuery(".reqcap").focusout(function(e) {
                    ...
                    try{
                        ...
                        //Get Source Data
                        var sourceData = $SourceDataDOMService.getItem();  
                        var updateStorage = $SourceDataDOMService.updateItem(sourceData, bos, id, userInput, quad); 
                ...
                jQuery(".progOverview").focusout(function(e) {
                ...
                jQuery(".progDesc").focusout(function(e) {
                ...
                jQuery(".POMAllocSec").focusout(function(e) {
                    ...
                    //Requirements/Capability to the Force Items
                     ...
                     //POM Allocation Items
                        ...
                        programItemData.then(function (programData) {//PROGRAM DATA
                            ...
                            //OTHER
                            var updateOTHERItem = $ProgramService.updateProgramPROC(programName, vm.otherItemID, 'OTHER1', bos, sourceData, vm.FYs);

                            //TOTAL
                            var updateTOTALItem = $ProgramService.updateProgramPROC(programName, vm.totalItemID, 'TOTAL1', bos, sourceData, vm.FYs);

                            //MYCFloor
                            var updateMYCFloorItem = $ProgramService.updateProgramPROC(programName, vm.MYCFloorUrlItemID, 'MYCFLOOR1', bos, sourceData, vm.FYs);
